...
# ====================================================================
# Purpose: Split clinvar_all_variants.csv into smaller files for faster upload
...
INPUT_FILE = PROJECT_ROOT / "data" / "raw" / "variants" / "clinvar_all_variants.csv"
OUTPUT_DIR = PROJECT_ROOT / "data" / "raw" / "variants" / "chunks"
