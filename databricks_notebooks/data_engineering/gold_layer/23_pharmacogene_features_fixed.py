...
# MAGIC - Pass 2: Target only. is_high_priority_pharmacogene derived independently.
...
print("GOLD PHARMACOGENE FEATURES - TWO-PASS")
print("="*80)
...
# DBTITLE 1,PASS 1 - Step 1: Gene Relationships
...
print(f"Genes with variant stats: {gene_variant_stats.count():,}")
...
gene_expression = (
    ...
    .join(
        ...
        col("gene_name") == col("liver_gene"), "left"
    )
    .drop("liver_gene")
    .join(
        ...
        col("gene_name") == col("kidney_gene"), "left"
    )
    .drop("kidney_gene")
...
print(f"Genes with disease data: {disease_genes.count():,}")
...
print(f"Genes with domain data: {protein_complexity.count():,}")

# COMMAND ----------

# DBTITLE 1,PASS 1 - Step 7: Join PharmGKB and All Enrichments
print("\nPASS 1 - STEP 7: JOIN ALL ENRICHMENTS")
print("="*80)
...
df_features = (
    ...
    .join(gene_expression,
          col("gene_symbol") == gene_expression["gene_name"], how="left")
...
# DBTITLE 1,PASS 1 - Step 8: Classification Flags and Scores
print("\nPASS 1 - STEP 8: CLASSIFICATION FLAGS AND SCORES")
print("="*80)
...
# DBTITLE 1,PASS 1 - Step 9: Deduplicate by Gene Symbol
print("\nPASS 1 - STEP 9: DEDUPLICATE BY GENE_SYMBOL")
print("="*80)
...
df_check.groupBy("is_high_priority_pharmacogene").count().orderBy("is_high_priority_pharmacogene").show()
print("\nProcessing complete")
